...
import it.readbeyond.minstrel.mediarb.MediaPlayer;
...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    private String mMode = null;             // Enable updating format
     ...
     */
    public AudioPlayer(AudioHandler handler, String id, String file, String mode) {
    ...
    public void onCompletion(android.media.MediaPlayer player) {
        Log.d(LOG_TAG, "on completion is calling completed");
        this.setState(STATE.MEDIA_COMPLETED);
    }
     ...
     */
    public boolean onError(android.media.MediaPlayer player, int arg1, int arg2) {
    ...
    /**
     * Set the playback speed for audio player
     *
     * @param speed
     */
    ...
    private boolean readyPlayer(String file) {
        if (playMode()) {
            switch (this.state) {
                case MEDIA_NONE:
                    if (this.player == null) {
                        this.player = new MediaPlayer(this.mMode);
                    }
                    try {
